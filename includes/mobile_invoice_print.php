...
function mobile_invoice_print_pdf_overrides_css(): string
{
    return '#m-inv-pdf-preview{box-sizing:border-box;width:100%;max-width:190mm;margin:0 auto;padding:8mm 6mm;background:#fff;'
        ...
        . '#m-inv-pdf-preview table.inv-print-lines th.inv-print-th-h{white-space:nowrap!important;vertical-align:middle!important;padding:4px 2px!important;font-size:7px!important;writing-mode:horizontal-tb!important;transform:none!important;}'
...
function mobile_invoice_print_table_css(): string
{
    return 'body{font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;color:#0f172a;margin:6mm 10mm 10mm;direction:rtl;}'
        ...
        . 'table.inv-print-lines th.inv-print-th-h{vertical-align:middle;padding:0.35rem 0.15rem;white-space:nowrap;font-size:8px;writing-mode:horizontal-tb;text-orientation:mixed;transform:none;}'
