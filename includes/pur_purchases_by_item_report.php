...
/**
 * بنود فواتير مشتريات مؤكدة بين تاريخين، لمادة محددة أو جميع المواد.
 *
 * @return list<array<string, mixed>>
 */
function pur_report_purchases_by_item(
    PDO $pdo,
    int $supplierId,
    int $itemId,
    string $from,
    ...
    if ($supplierId < 0 || $from === '' || $to === '' || $itemId < 0) {
        return [];
    }
    ...
    $supplierFilter = $supplierId > 0 ? ' AND i.supplier_id = ? ' : '';
