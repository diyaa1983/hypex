...
function mobile_icon_svg(string $key): string
{
    ...
    $icons = [
        ...
        'archive' => '<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path ' . $stroke . ' d="M4 7h16v13H4z"/><path ' . $stroke . ' d="M8 7V5h8v2"/><path ' . $stroke . ' d="M10 11h4M10 15h4"/></svg>',
