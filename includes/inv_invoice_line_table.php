 ...
 */
function inv_invoice_line_table_head(): void
{
    ?>
    <tr>
        ...
        <th class="sales-inv-col-price" title="سعر الوحدة قبل الضريبة">السعر الإفرادي</th>
 ...
 */
function inv_invoice_line_table_row_template(array $taxRates, string $unitPriceStep, string $amountStep): void
{
    ?>
    <tr data-line-id="" data-item-id="" data-name-ar="" class="is-entry-row">
        ...
        <td class="sales-inv-col-price"><input type="text" class="input input-num js-price" min="0" step="<?= esc($unitPriceStep) ?>" inputmode="decimal" value="" title="السعر الإفرادي"></td>
