/**
 * طباعة Node 2027 — إطار مستقل (iframe) مثل فواتير/تقارير النظام
 * لا يعتمد على CSS الصفحة ولا يضع شعار عملاق في DOM الشاشة.
 *
 * التوقيع: data-hx-print="standalone-v3" على body
 */
(function () {
  'use strict';
  ...
  function getContentHtml() {
    ...
    clone.querySelectorAll('.no-print, .si-rail, .ora-filters, script, style, .si-hero, .sidebar').forEach(
      function (el) {
        el.remove();
      }
    );
  ...
  /**
   * ترويسة مطابقة لتقارير 2027:
   * LTR: شعار يسار · اسم الشركة يمين، ثم عنوان في الوسط
   */
