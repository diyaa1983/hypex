...
$listUrl = app_url('index.php?r=sales_returns_documents_list');
$newReturnUrl = app_url('index.php?r=sales_returns');
$exitUrl = nav_exit_url('sales_returns_documents_list');

$pager = list_pager_from_request($pdo);
$result = sal_returns_documents_list_fetch($pdo, $search, $pager);
$rows = $result['rows'];
$pager = $result['pager'];
...
$listPagerUrl = list_pager_base_url('sales_returns_documents_list', $listPagerQuery);
...
<div class="dashboard-ora sales-ora12-screen sales-ora-list-page sales-inv-list-page sal-documents-list-page sal-returns-list-page"
     data-exit-url="<?= esc($exitUrl) ?>">
    <?php sales_ora12_render_title_bar('قائمة مرتجعات المبيعات'); ?>
