            ...
            <div class="sales-inv-meta-row">
                <div class="sales-inv-meta-item sales-inv-meta-no">
                    ...
                    <div class="sales-inv-no-nav">
                        ...
                        <input class="input input-compact sales-inv-no-input" type="text" id="inv_no" value="" placeholder="" title="يُولَّد الرقم تلقائياً عند الحفظ — للبحث اكتب جزءاً من رقم الفاتورة واضغط Enter">
        ...
        <section class="dashboard-ora-panel sales-inv-card">
            ...
            <div class="sales-inv-totals">
                <div class="row sales-inv-totals-disc">
                    <label for="inv-invoice-discount">خصم الفاتورة (كامل) <span class="sales-inv-disc-hint">10 أو 10% أو 1.000</span></label>
                ...
                <div class="row sales-inv-totals-header-disc" id="sales-inv-header-disc-row" hidden>
                    <span>قيمة خصم مستوى الفاتورة</span>
