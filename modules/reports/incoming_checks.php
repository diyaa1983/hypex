...
$filters = fin_incoming_checks_report_parse_filters($_GET);
...
$reportTitle = 'تقرير الشيكات الواردة';
$customerLabel = fin_incoming_checks_report_customer_label($pdo, $customerId);
$receiptEditBase = app_url('index.php?r=cash_receipt&id=');
...
<div class="card report-sales-page"<?= $pageDataAttrs ?>>
    ...
    <form method="get" action="<?= esc(app_url('index.php')) ?>" class="report-sales-filters report-checks-filters no-print">
        <input type="hidden" name="r" value="report_incoming_checks">
        <div class="form-row report-checks-filters-row">
            <label class="field report-checks-field report-checks-field--party">
                ...
                <select class="input" name="customer_id">
                    <option value="0" <?= $customerId === 0 ? 'selected' : '' ?>>جميع العملاء</option>
        ...
        <div class="report-sales-result report-sales-print-area">
            ...
            <div class="doc-print-meta">
                <table>
                    <tr>
                        <td>
                            <strong>العميل:</strong> <?= esc($customerLabel) ?>
                            &nbsp;&nbsp;|&nbsp;&nbsp;
            ...
            <div class="report-sales-table-wrap">
                <table class="report-sales-table report-incoming-checks-table js-sortable-report"
                    ...
                    <tr>
                        ...
                        <th class="col-customer js-sort-th" data-sort="party_name" data-sort-type="text" title="ترتيب تصاعدي/تنازلي">اسم العميل</th>
                        ...
                        <th class="col-inv-no js-sort-th" data-sort="voucher_no" data-sort-type="text" title="ترتيب تصاعدي/تنازلي">سند القبض</th>
                    ...
                    <?php if (!$rows): ?>
                        <tr>
                            <td colspan="9" class="muted" style="text-align:center;padding:1.25rem;">
                                لا توجد شيكات واردة مطابقة للفلتر المحدد.
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php
                    ...
                    foreach ($rows as $r):
                        ...
                        $postedLabel = fin_incoming_checks_report_posted_label($isPosted);
                        ...
                        $editUrl = $receiptEditBase . (int) ($r['voucher_id'] ?? 0);
                        ?>
                        <tr data-sort-row="1"
                            data-sort-seq="<?= $seq ?>"
